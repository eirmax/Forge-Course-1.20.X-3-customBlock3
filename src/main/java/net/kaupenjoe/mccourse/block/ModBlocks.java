...
public class ModBlocks {
    ...
    public static final RegistryObject<Block> IMPROVE_EMERALD_BLOCK = registerBlock("improve_emerald_block",
            () -> new Block(BlockBehaviour.Properties.of().mapColor(MapColor.METAL).instrument(NoteBlockInstrument.IRON_XYLOPHONE)
                    .requiresCorrectToolForDrops().strength(5.0F, 6.0F).sound(SoundType.METAL)));
    ...
    public static final RegistryObject<Block> EMERALD_STAIRS = registerBlock("emerald_stairs",
            () -> new StairBlock(() -> ModBlocks.IMPROVE_EMERALD_BLOCK.get().defaultBlockState(),
                    BlockBehaviour.Properties.copy(Blocks.IRON_BLOCK).sound(SoundType.NETHERRACK)));
